...
const HomeTabTemplate = ({ navigation, navigate }) => {
  const tabs = [{ label: "Explore", icon: "home" }, { label: "Share", icon: "camera" }, { label: "Profile", icon: "user" }];
...
export default HomeTabTemplate;
