...
const SignUpNameTemplate = ({ navigation, setLastNameRef, goToLastName, next }) => {
  return (
    <SignUpContainer title="Your Name" subtitle="Who are you" next={next} first {...{ navigation }}>
      <TextField placeholder="First Name" autoCapitalize="none" autoCorrect={false} returnKeyType="next" onSubmitEditing={goToLastName} />
      <TextField
